var CustomerdynamicTemplate = {
    ...
    customer: {
		...
		var type   = "Alphabetical";
                var header = CustomerdynamicTemplate.carrier.CustomerDynamicHeaderTemplate(type);
        ...
        CustomerDynamicList: function (cus) {
            ...
            var html = " <div class=\"parent-content-holder\"> <div class=\"topview p-relative\"> <div class=\"topview-leftcontent\">"
                    + "<img src=\"" + profilePicture + "\" alt=\"\" id=" + cusEmail + "  value=" + cus.carrierId + " class=\"carrier-img-width \" data-type=\"viewcustomerfeedview\"></div> <div class=\"topview-rightcontent\"> <div class=\"carrierid\" style=\"display:none;\">" + cus.carrierId + "</div><div class=\"topview-rightcontentcarrier-name t-caps \">" + cus.firstName + "</div> <div class=\"topview-rightcontentcarrier-location t-caps \">" + cus.residentialCity + "</div> <div class=\"topview-rightcontentcarrier-email\"><a href=\"mailto:" + cusEmail + "\">" + cusEmail + "</a></div> </div> <input type=\"checkbox\" class=\"getSelectedCustomers snap p-absolute\" data-type=\"customersCheckBox\" value=" + cusEmail + " id=" + cusEmail + " name=\"\"> <label for=" + cusEmail + " class=\"customer-feed-label\"></label> </div> <div class=\"downview p-relative\">"

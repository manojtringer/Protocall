        ...
        staticSettingsTemplate: function (data) {
            ...
            for (var index = 0; index < data.resultMap.listOfPreferredVendor.length; index++) {
                ...
                html += '<div id="item_' + index + '" class="preffered-border-view clr-fl border-bot left clr-fl"> <div class="preffered-view-left p-relative left"> <div class="carrier-left-width t-caps opensans-regular ">'
                        + '<input type="checkbox" id="removevendor_' + index + '" name="" class="checkbox remove-vendor"> <label for="removevendor_' + index + '" class="vendor-label"></label>'
                        ...
                        + '<div class="carrier-left-title t-left inline-block">' + data.resultMap.listOfPreferredVendor[index].phone.number + '</div> '
                        + '<div class="carrier-left-title t-right inline-block">' + data.resultMap.listOfPreferredVendor[index].latitude + '</div> </div> </div> </div> ';
            }

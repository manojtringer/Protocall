...
var overlay = {
    ...
    closeOverlay: function () {
		...
		$("#slideshow").empty();
		/* HOMEPAGERESPONSE.PROPERTYCARRIERNAMES = [];
		HOMEPAGERESPONSE.PROPERTYPHONENUMBER = [];
		HOMEPAGERESPONSE.PROPERTYNEXTPAYMENTAMOUNTDATE = [];
		HOMEPAGERESPONSE.VEHICLECARRIERNAMES = [];
		HOMEPAGERESPONSE.VEHICLEPHONENUMBER = [];
		HOMEPAGERESPONSE.VEHICLENEXTPAYMENTAMOUNTDATE = [];
		HOMEPAGERESPONSE.OTHERCARRIERNAMES = [];
		HOMEPAGERESPONSE.OTHERPHONENUMBER = [];
		HOMEPAGERESPONSE.OTHERNEXTPAYMENTAMOUNTDATE = []; */
		//$('.slide').empty();
    }
};

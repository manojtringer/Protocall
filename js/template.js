...
var template = {
	...
	feedsTemplateHTML:function(a){
		//console.log("dynamic-feed",a)
		            console.log(a.alertDetails.alertId)
				    console.log(a.userDetails.userId)
			  var  alertDate = a.alertDetails.alertDate;
		 ...
		 var html = '<div class="feed-block clr-fl">'
                    ...
                    + '</div>'
                    + '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-16 cust-name t-caps">'+a.userDetails.firstName+' ' +lastName+'</div>'
                    + '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-12 feed-time t-upper">'+alertTime+'</div>'
                    + '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-13 alert-color alert-type t-caps">'+a.alertDetails.type+'</div>'
                   ...
                   //    + '</div>'
                    ...
                    + '</div>'
                    + '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-12 feed-location t-caps">'+a.userDetails.residentialCity+'</div>'
                    + '<div class="p-relative inline-block v-align-bot">'
                    + '<div class="sprite-im phone-icon phone-icon-pos">&nbsp;</div>'
                    + '</div>'
                    + '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-12 cust-phone t-caps">'+a.userDetails.phone.number+'</div>'
                    + '<div class="p-relative inline-block v-align-bot">'

...
var template = {
    ...
    feedsTemplateHTML:function(alertDetailsValue){
		...
		var html = "",firstName = "",lastName = "",alertDate ="",alertTime ="",alertType ="",bDay ="",bDate ="",residentialCity = "",phoneNumber="",feedUserEmail ="",alertFeedHtml ="",noOfOtherPartyRecordsCount = alertDetailsValue.NoofOtherPartyRecord,noOfAudioRecordCount = alertDetailsValue.NoofAudioRecord,noOfPictureRecord = alertDetailsValue.NoofPictureRecord,profilePicture = "",rightSideAlerFeedHTML = "";
		console.log("noOfOtherPartyRecordsCount1",noOfOtherPartyRecordsCount);
		console.log("noOfAudioRecordCount1",noOfAudioRecordCount);
		console.log("noOfPictureRecord1",noOfPictureRecord);
		...
		if(alertDetailsValue.userDetails.birthDate){
	...
	incidentAlertFeeds : function(alertDetailsValue){
		console.log("alertDetails in feedsTemplateHTML",alertDetailsValue);
		var html = "",firstName = "",lastName = "",alertDate ="",alertTime ="",alertType ="",bDay ="",bDate ="",residentialCity = "",phoneNumber="",feedUserEmail ="",alertFeedHtml ="",noOfOtherPartyRecordsCount = alertDetailsValue.NoofOtherPartyRecord,noOfAudioRecordCount = alertDetailsValue.NoofAudioRecord,noOfPictureRecord = alertDetailsValue.NoofPictureRecord,profilePicture = "",rightSideAlerFeedHTML = "";
		console.log("noOfOtherPartyRecordsCount1",noOfOtherPartyRecordsCount);
		console.log("noOfAudioRecordCount1",noOfAudioRecordCount);
	...
	policyAlertFeeds : function(alertDetailsValue){
		console.log("policyAlertFeeds in policyAlertFeeds",alertDetailsValue);
		var html = "",firstName = "",lastName = "",alertDate ="",alertTime ="",alertType ="",bDay ="",bDate ="",residentialCity = "",phoneNumber="",feedUserEmail ="",alertFeedHtml ="",noOfOtherPartyRecordsCount = alertDetailsValue.NoofOtherPartyRecord,noOfAudioRecordCount = alertDetailsValue.NoofAudioRecord,noOfPictureRecord = alertDetailsValue.NoofPictureRecord,profilePicture = "",rightSideAlerFeedHTML = "";
		console.log("noOfOtherPartyRecordsCount1",noOfOtherPartyRecordsCount);
		console.log("noOfAudioRecordCount1",noOfAudioRecordCount);
		console.log("noOfPictureRecord1",noOfPictureRecord);
